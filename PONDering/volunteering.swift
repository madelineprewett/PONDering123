...
//public func darkSage(){
//    Color(red: 149 / 255, green: 172 / 255, blue: 129 / 255)
//}
...
struct volunteering: View {
    ...
    var body: some View {
        ZStack {
            Color(UIColor(red: 250/255.0, green: 237/255.0, blue: 205/255.0, alpha: 255/255.0))  .ignoresSafeArea()
            VStack {
                Text("Volunteering")
                    .font(.largeTitle)
                    .fontWeight(.bold)
                    .foregroundColor(Color(red: 212/255.0, green: 163/255.0, blue: 115/255.0))
            ...
            ScrollView {
                VStack {
                    ...
                    Text("Invasive Plant Removal at Oakland's Sibley Volcanic Regional Park")
                        ...
                        .padding(1)
                    VStack(alignment: .leading){
                        Text("Help with invasive plant removal and grassland restoration work, all tools are povided. This event is open to anyone 13+.")
                            .font(.title3)
                            .padding(1)
                        
                        Link(destination: URL(string: "https://apply.ebparks.org/custom/501/opp_details/2033")!) {
                            Text("Make sure to RSVP using this link")
                                .font(.title3)
